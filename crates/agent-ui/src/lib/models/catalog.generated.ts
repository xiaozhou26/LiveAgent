...
export type CatalogInputModality = "text" | "image" | "audio" | "video" | "pdf";
...
export const MODEL_CATALOG_SNAPSHOT_DATE = "2026-09-06";
...
export const MODEL_CATALOG: Record<CatalogProviderId, readonly CatalogModelEntry[]> = {
  anthropic: [
    ...
    { id: "claude-opus-4-5-20251101", contextWindow: 200000, maxOutputToken: 64000, inputModalities: ["text", "image", "pdf"], thinking: { levels: ["low", "medium", "high"], off: true } },
    { id: "claude-opus-4-6", contextWindow: 1000000, maxOutputToken: 128000, inputModalities: ["text", "image", "pdf"], thinking: { levels: ["low", "medium", "high", "max"], off: true } },
  ...
  google: [
    ...
    { id: "gemini-3.1-pro-preview-customtools", contextWindow: 1048576, maxOutputToken: 65536, inputModalities: ["text", "image", "audio", "video", "pdf"], thinking: { levels: ["low", "medium", "high"], off: false } },
    { id: "gemini-3.5-flash", contextWindow: 1048576, maxOutputToken: 65536, inputModalities: ["text", "image", "audio", "video", "pdf"], thinking: { levels: ["minimal", "low", "medium", "high"], off: false } },
    { id: "gemini-3.5-flash-lite", contextWindow: 1048576, maxOutputToken: 65536, inputModalities: ["text", "image", "audio", "video", "pdf"], thinking: { levels: ["minimal", "low", "medium", "high"], off: false } },
    ...
    { id: "gemini-flash-lite-latest", contextWindow: 1048576, maxOutputToken: 65536, inputModalities: ["text", "image", "audio", "video", "pdf"], thinking: { levels: ["minimal", "low", "medium", "high"], off: false } },
    { id: "gemma-4-26b-a4b-it", contextWindow: 262144, maxOutputToken: 32768, inputModalities: ["text", "image"], thinking: { levels: ["high"], off: true } },
    { id: "gemma-4-31b-it", contextWindow: 262144, maxOutputToken: 32768, inputModalities: ["text", "image"], thinking: { levels: ["high"], off: true } },
    { id: "lyria-3-clip-preview", contextWindow: 1048576, maxOutputToken: 65536, inputModalities: ["text", "image"] },
    { id: "lyria-3-pro-preview", contextWindow: 1048576, maxOutputToken: 65536, inputModalities: ["text", "image"] },
  ],
  openai: [
    { id: "gpt-3.5-turbo", contextWindow: 16385, maxOutputToken: 4096, inputModalities: ["text"] },
    { id: "gpt-4", contextWindow: 8192, maxOutputToken: 2048, inputModalities: ["text"] },
    { id: "gpt-4-turbo", contextWindow: 128000, maxOutputToken: 4096, inputModalities: ["text", "image"] },
    { id: "gpt-4.1", contextWindow: 1047576, maxOutputToken: 32768, inputModalities: ["text", "image", "pdf"] },
    { id: "gpt-4.1-mini", contextWindow: 1047576, maxOutputToken: 32768, inputModalities: ["text", "image", "pdf"] },
    { id: "gpt-4.1-nano", contextWindow: 1047576, maxOutputToken: 32768, inputModalities: ["text", "image"] },
    { id: "gpt-4o", contextWindow: 128000, maxOutputToken: 16384, inputModalities: ["text", "image", "pdf"] },
    { id: "gpt-4o-2024-05-13", contextWindow: 128000, maxOutputToken: 4096, inputModalities: ["text", "image"] },
    { id: "gpt-4o-2024-08-06", contextWindow: 128000, maxOutputToken: 16384, inputModalities: ["text", "image"] },
    { id: "gpt-4o-2024-11-20", contextWindow: 128000, maxOutputToken: 16384, inputModalities: ["text", "image"] },
    { id: "gpt-4o-mini", contextWindow: 128000, maxOutputToken: 16384, inputModalities: ["text", "image", "pdf"] },
    { id: "gpt-5", contextWindow: 400000, maxOutputToken: 128000, inputModalities: ["text", "image"], thinking: { levels: ["minimal", "low", "medium", "high"], off: false } },
    { id: "gpt-5-mini", contextWindow: 400000, maxOutputToken: 128000, inputModalities: ["text", "image"], thinking: { levels: ["minimal", "low", "medium", "high"], off: false } },
    { id: "gpt-5-nano", contextWindow: 400000, maxOutputToken: 128000, inputModalities: ["text", "image"], thinking: { levels: ["minimal", "low", "medium", "high"], off: false } },
    { id: "gpt-5-pro", contextWindow: 400000, maxOutputToken: 272000, inputModalities: ["text", "image"], thinking: { levels: ["high"], off: false } },
    { id: "gpt-5.1", contextWindow: 400000, maxOutputToken: 128000, inputModalities: ["text", "image"], thinking: { levels: ["low", "medium", "high"], off: true } },
    { id: "gpt-5.2", contextWindow: 400000, maxOutputToken: 128000, inputModalities: ["text", "image"], thinking: { levels: ["low", "medium", "high", "xhigh"], off: true } },
    { id: "gpt-5.2-chat-latest", contextWindow: 128000, maxOutputToken: 16384, inputModalities: ["text", "image"], thinking: { levels: ["medium"], off: false } },
    { id: "gpt-5.2-pro", contextWindow: 400000, maxOutputToken: 128000, inputModalities: ["text", "image"], thinking: { levels: ["medium", "high", "xhigh"], off: false } },
    ...
    { id: "gpt-5.5", contextWindow: 400000, maxOutputToken: 128000, inputModalities: ["text", "image"], thinking: { levels: ["low", "medium", "high", "xhigh"], off: true } },
    { id: "gpt-5.5-pro", contextWindow: 1050000, maxOutputToken: 128000, inputModalities: ["text", "image", "pdf"], thinking: { levels: ["medium", "high", "xhigh"], off: false } },
    { id: "gpt-5.6", contextWindow: 1050000, maxOutputToken: 128000, inputModalities: ["text", "image", "pdf"], thinking: { levels: ["low", "medium", "high", "xhigh", "max"], off: true } },
    ...
    { id: "o3", contextWindow: 200000, maxOutputToken: 100000, inputModalities: ["text", "image", "pdf"], thinking: { levels: ["low", "medium", "high"], off: false } },
    { id: "o3-mini", contextWindow: 200000, maxOutputToken: 100000, inputModalities: ["text"], thinking: { levels: ["low", "medium", "high"], off: false } },
    { id: "o3-pro", contextWindow: 200000, maxOutputToken: 100000, inputModalities: ["text", "image"], thinking: { levels: ["low", "medium", "high"], off: false } },
    { id: "o4-mini", contextWindow: 200000, maxOutputToken: 100000, inputModalities: ["text", "image"], thinking: { levels: ["low", "medium", "high"], off: false } },
    { id: "text-embedding-3-large", contextWindow: 8191, maxOutputToken: 3072, inputModalities: ["text"] },
    { id: "text-embedding-3-small", contextWindow: 8191, maxOutputToken: 1536, inputModalities: ["text"] },
    { id: "text-embedding-ada-002", contextWindow: 8192, maxOutputToken: 1536, inputModalities: ["text"] },
  ],
  xai: [
    { id: "grok-4.20-0309-non-reasoning", contextWindow: 1000000, maxOutputToken: 30000, inputModalities: ["text", "image", "pdf"] },
    { id: "grok-4.20-0309-reasoning", contextWindow: 1000000, maxOutputToken: 30000, inputModalities: ["text", "image", "pdf"], thinking: { levels: [], off: false } },
    { id: "grok-4.20-multi-agent-0309", contextWindow: 1000000, maxOutputToken: 30000, inputModalities: ["text", "image", "pdf"], thinking: { levels: ["low", "medium", "high", "xhigh"], off: false } },
  ...
  deepseek: [
    { id: "deepseek-v4-flash", contextWindow: 1000000, maxOutputToken: 384000, inputModalities: ["text"], thinking: { levels: ["low", "high", "max"], off: true } },
  ...
  zhipuai: [
    ...
    { id: "glm-4.5-air", contextWindow: 131072, maxOutputToken: 98304, inputModalities: ["text"], thinking: { levels: ["high"], off: true } },
    { id: "glm-4.5-flash", contextWindow: 131072, maxOutputToken: 98304, inputModalities: ["text"], thinking: { levels: ["high"], off: true } },
    ...
    { id: "glm-5", contextWindow: 204800, maxOutputToken: 131072, inputModalities: ["text"], thinking: { levels: ["high"], off: true } },
    { id: "glm-5-turbo", contextWindow: 200000, maxOutputToken: 131072, inputModalities: ["text"], thinking: { levels: ["high"], off: true } },
    { id: "glm-5.1", contextWindow: 200000, maxOutputToken: 131072, inputModalities: ["text"], thinking: { levels: ["high"], off: true } },
  ...
  moonshotai: [
    { id: "kimi-k2-0711-preview", contextWindow: 131072, maxOutputToken: 16384, inputModalities: ["text"] },
    { id: "kimi-k2-0905-preview", contextWindow: 262144, maxOutputToken: 32000, inputModalities: ["text"] },
    { id: "kimi-k2-thinking", contextWindow: 262144, maxOutputToken: 32000, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "kimi-k2-thinking-turbo", contextWindow: 262144, maxOutputToken: 32000, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "kimi-k2-turbo-preview", contextWindow: 262144, maxOutputToken: 32000, inputModalities: ["text"] },
    { id: "kimi-k2.5", contextWindow: 262144, maxOutputToken: 32000, inputModalities: ["text", "image", "video"], thinking: { levels: ["high"], off: true } },
  ...
  minimax: [
    ...
    { id: "MiniMax-M2.1", contextWindow: 204800, maxOutputToken: 131072, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "MiniMax-M2.5", contextWindow: 204800, maxOutputToken: 131072, inputModalities: ["text"], thinking: { levels: [], off: false } },
  ...
  stepfun: [
    ...
    { id: "step-2-16k", contextWindow: 16384, maxOutputToken: 8192, inputModalities: ["text"] },
  ...
  xiaomi: [
    ...
    { id: "mimo-v2-omni", contextWindow: 262144, maxOutputToken: 131072, inputModalities: ["text", "image", "audio", "video", "pdf"], thinking: { levels: ["high"], off: true } },
    { id: "mimo-v2-pro", contextWindow: 1048576, maxOutputToken: 131072, inputModalities: ["text"], thinking: { levels: ["high"], off: true } },
  ...
  alibaba: [
    { id: "deepseek-r1", contextWindow: 131072, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "deepseek-r1-0528", contextWindow: 131072, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "deepseek-r1-distill-llama-70b", contextWindow: 32768, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "deepseek-r1-distill-llama-8b", contextWindow: 32768, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "deepseek-r1-distill-qwen-1-5b", contextWindow: 32768, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "deepseek-r1-distill-qwen-14b", contextWindow: 32768, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "deepseek-r1-distill-qwen-32b", contextWindow: 32768, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "deepseek-r1-distill-qwen-7b", contextWindow: 32768, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "deepseek-v3", contextWindow: 65536, maxOutputToken: 8192, inputModalities: ["text"] },
    ...
    { id: "qvq-max", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text", "image"], thinking: { levels: [], off: false } },
    { id: "qwen-deep-research", contextWindow: 1000000, maxOutputToken: 32768, inputModalities: ["text"] },
    { id: "qwen-doc-turbo", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen-flash", contextWindow: 1000000, maxOutputToken: 32768, inputModalities: ["text"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen-long", contextWindow: 10000000, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen-math-plus", contextWindow: 4096, maxOutputToken: 3072, inputModalities: ["text"] },
    { id: "qwen-math-turbo", contextWindow: 4096, maxOutputToken: 3072, inputModalities: ["text"] },
    { id: "qwen-max", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen-mt-plus", contextWindow: 16384, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen-mt-turbo", contextWindow: 16384, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen-omni-turbo", contextWindow: 32768, maxOutputToken: 2048, inputModalities: ["text", "image", "audio", "video"] },
    { id: "qwen-omni-turbo-realtime", contextWindow: 32768, maxOutputToken: 2048, inputModalities: ["text", "image", "audio"] },
    { id: "qwen-plus", contextWindow: 1000000, maxOutputToken: 32768, inputModalities: ["text"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen-plus-character", contextWindow: 32768, maxOutputToken: 4096, inputModalities: ["text"] },
    { id: "qwen-plus-character-ja", contextWindow: 8192, maxOutputToken: 512, inputModalities: ["text"] },
    { id: "qwen-turbo", contextWindow: 1000000, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen-vl-max", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text", "image"] },
    { id: "qwen-vl-ocr", contextWindow: 34096, maxOutputToken: 4096, inputModalities: ["text", "image"] },
    { id: "qwen-vl-plus", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text", "image"] },
    { id: "qwen2-5-14b-instruct", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen2-5-32b-instruct", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen2-5-72b-instruct", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen2-5-7b-instruct", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen2-5-coder-32b-instruct", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen2-5-coder-7b-instruct", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text"] },
    { id: "qwen2-5-math-72b-instruct", contextWindow: 4096, maxOutputToken: 3072, inputModalities: ["text"] },
    { id: "qwen2-5-math-7b-instruct", contextWindow: 4096, maxOutputToken: 3072, inputModalities: ["text"] },
    { id: "qwen2-5-omni-7b", contextWindow: 32768, maxOutputToken: 2048, inputModalities: ["text", "image", "audio", "video"] },
    { id: "qwen2-5-vl-72b-instruct", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text", "image"] },
    { id: "qwen2-5-vl-7b-instruct", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text", "image"] },
    { id: "qwen3-14b", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3-235b-a22b", contextWindow: 131072, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3-32b", contextWindow: 131072, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3-8b", contextWindow: 131072, maxOutputToken: 8192, inputModalities: ["text"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3-asr-flash", contextWindow: 53248, maxOutputToken: 4096, inputModalities: ["audio"] },
    { id: "qwen3-coder-30b-a3b-instruct", contextWindow: 262144, maxOutputToken: 65536, inputModalities: ["text"] },
    { id: "qwen3-coder-480b-a35b-instruct", contextWindow: 262144, maxOutputToken: 65536, inputModalities: ["text"] },
    ...
    { id: "qwen3-omni-flash-realtime", contextWindow: 65536, maxOutputToken: 16384, inputModalities: ["text", "image", "audio"] },
    { id: "qwen3-vl-235b-a22b", contextWindow: 131072, maxOutputToken: 32768, inputModalities: ["text", "image"], thinking: { levels: [], off: false } },
    { id: "qwen3-vl-30b-a3b", contextWindow: 131072, maxOutputToken: 32768, inputModalities: ["text", "image"], thinking: { levels: [], off: false } },
    { id: "qwen3-vl-plus", contextWindow: 262144, maxOutputToken: 32768, inputModalities: ["text", "image"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3.5-122b-a10b", contextWindow: 262144, maxOutputToken: 65536, inputModalities: ["text", "image", "audio", "video"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3.5-27b", contextWindow: 262144, maxOutputToken: 65536, inputModalities: ["text", "image", "audio", "video"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3.5-35b-a3b", contextWindow: 262144, maxOutputToken: 65536, inputModalities: ["text", "image", "audio", "video"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3.5-397b-a17b", contextWindow: 262144, maxOutputToken: 65536, inputModalities: ["text", "image", "video"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3.5-flash", contextWindow: 1000000, maxOutputToken: 65536, inputModalities: ["text", "image", "video"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3.5-plus", contextWindow: 1000000, maxOutputToken: 65536, inputModalities: ["text", "image", "video"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3.6-27b", contextWindow: 262144, maxOutputToken: 65536, inputModalities: ["text", "image", "audio", "video"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
    { id: "qwen3.6-35b-a3b", contextWindow: 262144, maxOutputToken: 65536, inputModalities: ["text", "image", "audio", "video"], thinking: { levels: ["minimal", "low", "medium", "high"], off: true } },
  ...
  tencent: [
    { id: "hunyuan-2.0-instruct", contextWindow: 131072, maxOutputToken: 16384, inputModalities: ["text"] },
    { id: "hunyuan-2.0-thinking", contextWindow: 131072, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "hunyuan-t1", contextWindow: 131072, maxOutputToken: 16384, inputModalities: ["text"], thinking: { levels: [], off: false } },
    { id: "hunyuan-turbos", contextWindow: 131072, maxOutputToken: 16384, inputModalities: ["text"] },
    { id: "tc-code-latest", contextWindow: 131072, maxOutputToken: 16384, inputModalities: ["text"] },
  ],
};
