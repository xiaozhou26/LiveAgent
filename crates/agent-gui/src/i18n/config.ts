...
export const GUI_TRANSLATION_OVERRIDES: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.backupDomainSystem": "系统偏好",
    "settings.backupDomainAgents": "提示词模板",
    "settings.backupDomainModelFailover": "模型故障转移",
    "settings.backupDomainStt": "语音识别",
    ...
    "settings.backupScopeSkills": "技能",
    "settings.backupScopeDeviceLocal": "工作目录与代理",
    ...
    "settings.globalShortcutsDesc":
      "发送方式点击切换；其他快捷键点击条目或键帽录制，Esc 取消。全局快捷键可在其他应用中使用；应用快捷键仅在 LiveAgent 获得焦点时生效。",
    "settings.shortcutScope": "生效范围",
    "settings.shortcutScopeSwitch": "点击切换：左侧全局快捷键，右侧应用快捷键",
    "settings.shortcutScopeGlobal": "全局",
    "settings.shortcutScopeApp": "应用",
    "settings.shortcutSend": "发送消息",
    "settings.shortcutSendEnterDesc": "按 Enter 发送，Shift + Enter 换行",
    "settings.shortcutSendModifiedDesc": "按 Enter 换行，使用组合键发送",
    "settings.shortcutSendSwitchHint": "点击切换发送方式",
    "settings.shortcutClickToRecord": "点击录制",
    "settings.shortcutScopeComposer": "输入框内",
    "settings.shortcutSendScopeDesc": "仅在消息输入框中生效，Shift + Enter 始终换行。",
    "settings.shortcutSaveFailed": "无法保存快捷键，请检查本机存储是否可用。",
  ...
  "en-US": {
    ...
    "settings.globalShortcutsDesc":
      "Click to switch the send shortcut. For other shortcuts, click a row or its keys to record; Esc cancels. Global shortcuts work in other apps; App shortcuts work while LiveAgent is focused.",
